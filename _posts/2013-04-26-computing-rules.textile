...
For example, after using a highly customized "@awesome@":http://awesome.naquadah.org/ for several years, I switched to using Debian and switched to KDE. I can get a new computer up and running in less than half an hour and without any prior configuration, all my machines work and "feel" the same way. YMMV. I'm not a deskmodder, I'm an admin. Nevertheless, I like to have my complete set of software and I have a "Makefile for that":https://src.hanneseichblatt.de/heichblatt/default-environment/blob/master/Makefile.
